...
namespace Rasa.Structures
{
    public class Inventory
    {
        ...
        public List<uint> PersonalInventory = new List<uint>(); // change index
        public List<uint> HomeInventory = new List<uint>();   // LockBox
        public List<uint> ClanInventory = new List<uint>();   // ClanLockBox
        ...
        public List<uint> EquippedInventory = new List<uint>();
