...
public class Logger
{
    ...
    public static void WriteLog(LogType type, object log) => WriteLog(type, log?.ToString() ?? "null");
    public static void WriteLog(LogType type, string format, params object[] args) => WriteLog(type, string.Format(format, args));
