...
namespace Rasa.Services.Preloader
{
    ...
    public class CreaturePreloader : PreloaderBase, IPreloader
    {
        ...
        protected override IEnumerable<object[]> GetRows()
        {
            ...
            yield return new object[] { 43, "Warrior Aprika", 22637, 1, 10, 900, 2969, 6.5, 3.25, 2, 0, 0, 0, 0, 0, 0, 0 };
            ...
            yield return new object[] { 50, "NPC_Forean_Spearman", 7034, 1, 9, 500, 0, 7, 3.25, 17, 6, 5, 0, 0, 0, 0, 0 };
            yield return new object[] { 51, "NPC_Forean_Gunner", 7033, 1, 9, 500, 0, 7, 3.25, 0, 0, 0, 0, 0, 0, 0, 0 };
            yield return new object[] { 52, "NPC_Forean_Shaman", 7035, 1, 9, 500, 3000, 7, 3.25, 0, 0, 0, 0, 0, 0, 0, 0 };
            yield return new object[] { 53, "NPC_Forean_Archer", 7036, 1, 9, 500, 0, 7, 3.25, 0, 0, 0, 0, 0, 0, 0, 0 };
