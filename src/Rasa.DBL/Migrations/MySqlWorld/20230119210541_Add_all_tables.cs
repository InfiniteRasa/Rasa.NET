        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<uint>(type: "int unsigned", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    giver_id = table.Column<uint>(type: "int unsigned", nullable: false),
                    reciver_id = table.Column<uint>(type: "int unsigned", nullable: false),
                    level = table.Column<uint>(type: "int unsigned", nullable: false),
                    group_type = table.Column<byte>(type: "tinyint unsigned", nullable: false),
