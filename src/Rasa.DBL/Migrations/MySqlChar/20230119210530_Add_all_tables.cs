        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    abilitiy_slot = table.Column<int>(type: "int", nullable: false),
                    ability_id = table.Column<int>(type: "int", nullable: false),
                    ability_level = table.Column<uint>(type: "int unsigned", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    character_id = table.Column<uint>(type: "int unsigned", nullable: false),
                    invenotry_type = table.Column<uint>(type: "int unsigned", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    purashed_tabs = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    mission_state = table.Column<uint>(type: "int unsigned", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    character_id = table.Column<uint>(type: "int unsigned", nullable: false),
                    option_id = table.Column<uint>(type: "int unsigned", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    character_id = table.Column<uint>(type: "int unsigned", nullable: false),
                    waypointId = table.Column<uint>(type: "int unsigned", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    account_id = table.Column<uint>(type: "int unsigned", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    friend_account_id = table.Column<uint>(type: "int unsigned", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    account_id = table.Column<uint>(type: "int unsigned", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ignored_account_id = table.Column<uint>(type: "int unsigned", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ammo_count = table.Column<uint>(type: "int unsigned", nullable: false),
