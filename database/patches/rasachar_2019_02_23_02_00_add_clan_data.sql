CREATE TABLE `rasachar`.`clan_ranks` (
  ...
  UNIQUE INDEX `rank_number_UNIQUE` (`rank_number` ASC) VISIBLE)
COMMENT = 'Default rank titles for clans used during clan create';
